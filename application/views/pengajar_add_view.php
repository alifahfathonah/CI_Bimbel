        ...
        <div class="card">
              ...
              <div class="card-body"> 
                  <div class="form-group">
                    <label>Nama</label>
                    <input type="text" class="form-control" name="nama" placeholder="Masukkan nama pengajar">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label>Umur</label>
                    <input type="text" class="form-control" name="umur" placeholder="Masukkan umur pengajar">
                  </div>
                  <div class="form-group">
                ...
                <div class="card-footer">
                  <button type="submit" name="pengajar_submit" class="btn btn-primary">Tambah baru</button>
                </div>
            </div>
            </form>
      </div>

        ...
        <div class="card">
              ...
              <div class="card-body"> 
                  <div class="form-group">
                    <label>Id</label>
                    <input type="text" class="form-control" name="id" readonly value="<?php echo $model->id_evaluasi ?>">
                  </div> 
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select name="id_siswa" class="form-control">
                      ...
                      <?php foreach ($siswa_rows as $row) {
                        if ($row->id_siswa == $model->id_siswa){
                            ?>
                      <option value="<?php echo $row->id_siswa; ?>" selected><?php echo $row->nama_siswa; ?></option>
                      <?php
                        } else {
                      ?>
                  ...
                  <div class="form-group">
                    <label>Niai</label>
                    <input type="text" class="form-control" name="nilai" value="<?php echo $model->nilai ?>">
                  </div>
                  <div class="card-footer">
                    <button type="submit" name="nilai_submit" class="btn btn-primary">Ubah</button>
                  </div>
            </div>
            </form>
      </div>
